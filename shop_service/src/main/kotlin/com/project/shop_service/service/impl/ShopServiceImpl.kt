...
import com.project.shop_service.rabbit.RabbitProducer
...
@Service
class ShopServiceImpl(private val shopQuery: ShopQuery, private val rabbitProducer: RabbitProducer) : ShopService {
    ...
    override fun getShopService(id: Int): ResponseEntity<ShopVo> {
        ...
        rabbitProducer.sendDataToStore(shop)
